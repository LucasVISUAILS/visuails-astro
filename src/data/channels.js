...
export const CHANNELS = [
  {
    ...
    minPx: 1000,
    zoomPx: 1600,
    /* Eén regel op de kaart; de volledige eis staat achter het vraagteken (note). 3 sep 2026. */
    short: { en: 'Main image on pure white — we take care of that.', nl: 'Hoofdbeeld op zuiver wit — dat regelen wij.' },
    note: {
  ...
  },
  {
    ...
    zoomPx: 1200,
    /* Eén regel op de kaart; de volledige eis staat achter het vraagteken (note). 3 sep 2026. */
    short: { en: 'Main image on white, no model on it — the on-model shot goes second.', nl: 'Hoofdbeeld op wit, zonder model — de on-model shot komt daarachter.' },
    note: {
  ...
  },
  {
    ...
    zoomPx: 1801,
    /* Eén regel op de kaart; de volledige eis staat achter het vraagteken (note). 3 sep 2026. */
    short: { en: 'Packshots on white, JPG only. Read the note about the on-model shot.', nl: 'Packshots op wit, alleen JPG. Lees de notitie over de on-model shot.' },
    note: {
  ...
  },
  {
    ...
    /* Eén regel op de kaart; de volledige eis staat achter het vraagteken (note). 3 sep 2026. */
    short: { en: 'Your shop, your rules — any colour, any crop.', nl: 'Jouw shop, jouw regels — elke kleur, elke uitsnede.' },
    note: {
  ...
  },
  {
    ...
    formats: ['jpg', 'png', 'webp'],
    /* Eén regel op de kaart; de volledige eis staat achter het vraagteken (note). 3 sep 2026. */
    short: { en: 'No background rule. You place the AI label on the post yourself.', nl: 'Geen achtergrondregel. De AI-vermelding op je post plaats je zelf.' },
    note: {
  ...
  },
  {
    ...
    formats: ['jpg', 'png', 'webp'],
    /* Eén regel op de kaart; de volledige eis staat achter het vraagteken (note). 3 sep 2026. */
    short: { en: 'No background rule. The AI disclosure is already in the file.', nl: 'Geen achtergrondregel. De AI-vermelding zit al in het bestand.' },
    note: {
...
export const COPY = {
  en: {
    ...
    detailTerm: 'the requirements',
    whiteWarnH: 'The background is fixed to pure white',
    whiteWarnShort: 'Amazon, bol and Zalando require it — locked to #FFFFFF for this order.',
    ...
    splitShort: 'Order the product twice: once on white, once in your own colour. Both count as a normal product.',
    ...
    orderShort: 'Lead with the front packshot; the on-model shot goes among the additional images.',
  ...
  nl: {
    ...
    whiteWarnShort: 'Amazon, bol en Zalando eisen dat — voor deze bestelling vast op #FFFFFF.',
    ...
    splitShort: 'Bestel het product twee keer: één keer op wit, één keer in je eigen kleur. Allebei tellen als gewoon product.',
    ...
    orderShort: 'Zet de voorkant-packshot vooraan; de on-model shot hoort bij de extra afbeeldingen.',
