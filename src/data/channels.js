...
export const COPY = {
  en: {
    ...
    split: 'Order the same product twice: one marketplace version on white, and one for your own shop and socials in the colour you want. The second one is a normal product on the ladder, so it is charged at the rate your total lands on — not as a surcharge.',
  ...
  nl: {
    ...
    split: 'Bestel hetzelfde product twee keer: één marktplaatsversie op wit, en één voor je eigen shop en socials in de kleur die je wilt. Die tweede telt als een gewoon product op de staffel, dus je betaalt het tarief waar je totaal op uitkomt — geen toeslag.',
