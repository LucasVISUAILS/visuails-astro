...
export const COPY = {
  en: {
    ...
    lead: 'A Brand Model is designed once, for you, and used nowhere else. It is not something you pick off a list — so this is a short brief, and then we look at it together and come back with directions before anything is built.',
    formH: 'The brief',
    ...
    legal: ['By sending this brief you agree to our ', ' and ', '.'],
    legalTerms: 'terms',
    legalPrivacy: 'privacy policy',
    afterH: 'What happens next',
    after: [
      'We read the brief and come back within two working days with directions — not one face, a few, so you have something to react to.',
    ...
    priceNote: 'Nothing is charged for the brief or for the conversation. The setup fee and how it is paid are settled before anything is built, never after.',
  },
  nl: {
    eyebrow: 'Merkmodel',
    h1: 'Vertel ons wie het moet dragen.',
    lead: 'Een merkmodel wordt één keer ontworpen, voor jou, en nergens anders gebruikt. Het is niets wat je uit een lijst kiest — dus dit is een korte briefing, en daarna kijken we er samen naar en komen we met richtingen terug voordat er iets gebouwd wordt.',
    formH: 'De briefing',
    ...
    featuresHint: 'Dit is het veld dat van een gezicht jóúw gezicht maakt. Sproeten, grijs haar, een gezichtstattoo, een spleetje tussen de tanden, een bril, natuurlijke textuur — wat jou zou opvallen.',
    ...
    submit: 'Stuur de briefing',
    legal: ['Door deze briefing te versturen ga je akkoord met onze ', ' en ', '.'],
    legalTerms: 'algemene voorwaarden',
    legalPrivacy: 'privacyverklaring',
    afterH: 'Wat er daarna gebeurt',
    after: [
      'We lezen de briefing en komen binnen twee werkdagen terug met richtingen — niet één gezicht maar een paar, zodat je iets hebt om op te reageren.',
    ...
    priceNote: 'Voor de briefing en het gesprek wordt niets berekend. Het setupbedrag en hoe je dat betaalt, spreken we af voordat er iets gebouwd wordt — nooit achteraf.',
  },
};
