...
export const COPY = {
  en: {
    ...
    after: [
      'Within two working days you get directions — not one face, a few, so you have something to react to.',
  ...
  nl: {
    ...
    after: [
      'Binnen twee werkdagen krijg je richtingen — niet één gezicht maar een paar, zodat je iets hebt om op te reageren.',
